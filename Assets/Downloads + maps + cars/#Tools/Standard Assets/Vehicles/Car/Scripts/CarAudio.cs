...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        // lowAccelClip : (i.e. begining acceleration at very low speed)
        // highAccelClip : (i.e. accelerating, but almost at max speed)
        // lowDecelClip : (i.e. idling or engine-braking at very low speed)
        // highDecelClip : (i.e. engine-braking at very high speed)
